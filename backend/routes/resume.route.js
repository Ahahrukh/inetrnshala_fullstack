...
resumeRouter.post("/upload",authentication,upload,async(req,res)=>{
...
resumeRouter.get("/myresume",authentication,async(req,res)=>{
    let resume=await resumeModel.find()

    res.send(resume)
})

resumeRouter.delete("/deresume/:id",authentication,async (req,res)=>{
      const {id}=req.params
